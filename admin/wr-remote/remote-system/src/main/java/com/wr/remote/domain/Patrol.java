...
@ApiModel("巡更")
@TableName(value = "xccj_community.bus_patrol")
public class Patrol extends BaseEntity {
    ...
    @TableField(exist = false)
    private List<String> patrolImages;
    //维修状况0=无1=有
    @Excel(name = "维修状况", readConverterExp = "0=无,1=有")
    private String stateRepair;
    //	巡更状态数据字典patrol_status
    @Excel(name = "巡更/执行状态", readConverterExp = "0=待上报,1=待执行,2=执行中,3=已完成,4=已超期")
