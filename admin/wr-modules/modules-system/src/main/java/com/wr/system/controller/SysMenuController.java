...
public class SysMenuController extends BaseController
{
    ...
    public AjaxResult treeselect(SysMenu menu)
    {
        ...
        List<SysMenu> menus = list.stream().filter(m -> "ALL".equals(m.getPlatType()) || "SYSTEM".equals(m.getPlatType())).collect(Collectors.toList());
     ...
     * 获取菜单下拉树列表
     */
    @GetMapping("/treeForVer")
    public AjaxResult treeForVer(SysMenu menu) {
        Long userId = SecurityUtils.getUserId();
        List<SysMenu> list = menuService.selectMenuList(menu, userId);
        if(list.isEmpty()){
            return AjaxResult.success(Lists.newArrayList());
    ...
    public AjaxResult add(@Validated @RequestBody SysMenu menu)
    {
        ...
        {
            return AjaxResult.error("新增菜单'" + menu.getMenuName() + "'失败，外链菜单必须以“http(s)://”开头");
        }
