 ...
 */
@Mapper
public interface DecorationMapper extends BaseMapper<BusDecorate> {
     ...
     * @return
     */
    List<Worker> getWorkerListByDecorateId(Long decorateId);
     ...
     * @return
     */
    List<Liaison> getLiaisonList(Long decorateId);
    ...
    List<DecorateViolation> getViolationList(@Param("decorateId") String decorateId);
}
