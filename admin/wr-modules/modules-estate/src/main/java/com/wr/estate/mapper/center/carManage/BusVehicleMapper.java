...
public interface BusVehicleMapper {
     ...
     * @return
     */
    BusVehicleVo selectUpdateDetail(@Param("vehicleId") Long vehicleId);

    BusVehicleVo getAccountIdOwner(@Param("accountId") Long accountId);
     ...
     * @return
     */
    BusVehicleVo selectOwnerIdAndCommunityIdByVehicle(@Param("loginPhone") String loginPhone, @Param("communityId") Long communityId);
     ...
     * @return
     */
    List<SelectVehicleVo> getByOwnerIdVehicleList(@Param("communityId") Long communityId, @Param("ownerId") Long ownerId);
     ...
     * @return
     */
    List<SelectVehicleVo> getByAccountIdVehicleList(@Param("communityId") Long communityId, @Param("accountId") Long accountId);
}