...
import com.wr.work.service.cleaningWorkOrder.CleaningWorkOrderService;
...
public class CleaningWorkOrderSettingExpired extends KeyExpirationEventMessageListener {
    ...
    public void onMessage(Message message, byte[] pattern) {
        ...
        if (redisKey.contains(CacheConstants.QJ_WORK_ORDER)) {
            log.info("START生成清洁工单....");
            String  cleaningWorkOrderSettingId = redisKeys[3];
            CleaningWorkOrderSetting cleaningWorkOrderSetting = cleaningWorkOrderSettingService.getById(cleaningWorkOrderSettingId);
            try {
                ...
                for (String executorBy : executorBys) {
                    ...
                    cleaningWorkOrder.setCleaningAddress(cleaningWorkOrderSetting.getCleaningAddress());
            ...
            //工单到期
            log.info("START清洁工单到期....");
            String cleaningWorkOrderId = redisKeys[1];
