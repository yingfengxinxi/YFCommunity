...
import com.wr.api.estate.mapper.order.DecorateOrderMapper;
...
public class DecorateOrderServiceImpl implements OrderService {
    ...
    public List<OrderListVO> listPage(OrderQueryVO query) {
        return decorateOrderMapper.listDecorateOrders(query);
    }
    ...
    public Object detail(OrderQueryVO query) {
        DecorateOrderDetailVO detail = decorateOrderMapper.detailDecorateOrder(query.getOrderId());
        Integer hasCharge = 2;
    ...
    public void robOrder(OrderQueryVO query) {
        int i = decorateOrderMapper.robOrder(query);
        if (i <= 0) {
    ...
    public void receiveOrder(OrderQueryVO query) {
        int i = decorateOrderMapper.receiveOrder(query);
        if (i <= 0) {
    ...
    public void startPerform(OrderQueryVO order) {
        int i = decorateOrderMapper.startPerform(order);
        if (i <= 0) {
    ...
    public void finish(OrderQueryVO order) {
        decorateOrderMapper.finish(order);
    ...
    public void transfer(OrderQueryVO order) {
        ...
        int i = decorateOrderMapper.transfer(order);
        if (i <= 0) {
