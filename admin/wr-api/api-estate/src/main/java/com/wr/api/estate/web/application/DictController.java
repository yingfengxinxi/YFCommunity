...
public class DictController {
     ...
     * @return
     */
    @GetMapping("/getSysConfigCache/{key}")
    public AjaxResult getSysConfigCache(@PathVariable("key") String key) {

        return AjaxResult.success(redisService.getCacheObject(CacheConstants.SYS_CONFIG_KEY + key));
    }
}
