 ...
 */
@RestController
@RequestMapping("/estateapi/communityInformation")
@Api(tags = "业主端-社区资讯")
public class CommunityInformationController extends BaseController {
    ...
    public TableDataInfo list(@RequestBody CommunityInformation communityInformation) {
        Long estateId = communityInformation.getEstateId();
    ...
    public AjaxResult detail(@RequestParam("id") String id) {
        UpdateWrapper<CommunityInformation> updateWrapper = new UpdateWrapper<>();
        updateWrapper.eq("id", id).setSql("look_number = look_number + 1");
        communityInformationService.update(null, updateWrapper);
