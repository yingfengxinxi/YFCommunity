...
import com.wr.common.security.business.annotation.ApiFieldRepeat;
 ...
 * @Desc: 校验规则
 */
public class ApiFieldRepeatValidator implements ConstraintValidator<ApiFieldRepeat, List<String>> {
    private static final Logger log = LoggerFactory.getLogger(ApiFieldRepeatValidator.class);

    @Autowired
    private RemoteFieldApiService fieldService;
    ...
    @Override
    public void initialize(ApiFieldRepeat validator) {
        log.info("验证开始===>");
