...
<!--        <el-form-item label="所属小区" prop="userCommunityName">
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['autonomy:social:delete']"
          >删除
          </el-button>
        </el-col>
        ...
        >
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['autonomy:social:query']"
            >查看
            </el-button>
            <el-button
              size="mini"
    ...
    <div v-show=checkSysView >
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="sysHandleAdd"
            v-hasPermi="['autonomy:social:add']"
          >新增
          </el-button>
        </el-col>
        <el-col :span="1.5">
      ...
      <!--表单-->
      <el-table v-loading="sysLoading" :data="sysSocialList" row-key="socialId"  @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="50" align="center" />
<!--        <el-table-column label="发布内容" align="center" key="content" prop="content"/>-->
        ...
        >
          <template slot-scope="scope">
            ...
            <el-button
              ...
              v-hasPermi="['autonomy:social:edit']"
            >编辑
            </el-button>
            <el-button
              size="mini"
              ...
              style="color: #f56c6c"
              icon="el-icon-delete"
              @click="sysHandleDeleteOne(scope.row)"
              v-hasPermi="['autonomy:social:delete']"
            >删除
            </el-button>
          </template>
      ...
      <el-dialog :title="title" :visible.sync="checkAddUpdateView" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
          ...
          <el-form-item prop="socialUrl" label="上传图片"  label-position="left">
            <el-upload
            ...
            <span v-show="checkPhoto" style="color: #C03639">请上传图片</span>
          </el-form-item>
        </el-form>
...
import {
  ...
  uploadPicture
} from "@/api/govern/autonomy/social/social";
import {addComment, getCommentList, queryLikeAmount,revokeMsg} from "@/api/govern/autonomy/social/comment";
export default {
  name: "lease",
  data() {
    return {
