<template>
  <div class="app-container">
    <div v-show="!open">
      ...
      <el-table v-loading="loading" :data="memberList" v-show="show" @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55" align="center"/>
        <el-table-column label="姓名" align="center" prop="memberName" show-overflow-tooltip/>
        <el-table-column label="手机号" align="center" prop="memberPhone" show-overflow-tooltip/>
        <el-table-column label="入党日期" align="center" prop="joinTime" show-overflow-tooltip>
        ...
        <el-table-column label="党内职务" align="center" prop="memberDuty" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column label="住址" align="center" prop="address" width="150px" show-overflow-tooltip/>
    ...
    <!-- 查看党员列表-->
    <el-dialog title="详情信息" :visible.sync="showDetail" :before-close="closeDetail">
      <el-form ref="form" :model="form" label-width="100px">
        <el-row>
          ...
          <el-col :span="6" :offset="3">
            <el-form-item label="联系电话:">{{ form.memberPhone }}</el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="6" :offset="3">
            <el-form-item label="党内职务：">{{ form.memberDuty }}</el-form-item>
          </el-col>
          <el-col :span="8" :offset="3">
        ...
        <el-row>
          <el-col :span="6" :offset="3">
            <el-form-item label="驳回理由：">{{ form.rejectReason }}</el-form-item>
          </el-col>
        </el-row>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="closeDetail()" style="margin-left: 10px">关 闭</el-button>
      </div>
    </el-dialog>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="驳回理由" prop="rejectReason">
          <el-input onKeypress="javascript:if(event.keyCode == 32)event.returnValue = false;" type="textarea" :rows="5"
                    v-model="form.rejectReason" placeholder="请输入驳回理由（20字以内）"
...
import {rejectedList} from "@/api/govern/member/rejected";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      rejectedList(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
