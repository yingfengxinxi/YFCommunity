...
<!--              <el-select
          ...
          <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
              <el-button
                ...
                size="mini"
                @click="handleAdd"
                v-hasPermi="['nightPatrol:plan:add']"
              >新增
              </el-button>
            </el-col>
            <el-col :span="1.5">
              <el-button
                ...
                :disabled="multiple"
                @click="handleDelete"
                v-hasPermi="['nightPatrol:plan:delete']"
              >删除
              </el-button>
            </el-col>
          </el-row>
          ...
          <el-table ref="planRef" v-loading="loading" :data="list" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="巡更类型" align="center" prop="tourName"/>
            <el-table-column label="巡更点数量" align="center" prop="pointNumber"/>
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" style="{'color':}">
              <template slot-scope="scope">
                ...
                <el-button
                  ...
                  v-hasPermi="['nightPatrol:plan:edit']"
                  v-show="scope.row.planOrder === '1'"
                >修改
                </el-button>
      ...
      <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
          ...
          <el-form-item label="巡更模式" prop="planModel">
            <el-radio v-model="form.planModel" :label="planModel.id" border v-for="planModel in planModelList">
              {{ planModel.value }}
            </el-radio>
          </el-form-item>
          <el-form-item label="巡更顺序" prop="planModel">
            <el-radio v-model="form.watchmanType" :label="sort.id" border v-for="sort in sortList">
              {{ sort.value }}
            </el-radio>
          </el-form-item>
          ...
          <div v-show="form.planModel === '0'">
            <el-form-item label="巡更次数" prop="planNum">
              <el-input-number v-model="form.planNum" controls-position="right" :min="1" :max="10"
                               style="width: 100%"><i slot="suffix" class="el-input__icon">次</i></el-input-number>
            </el-form-item>
          ...
          <div v-show="form.planModel === '1'">
            <el-form-item label="巡更频率" prop="planNum">
              <el-input-number v-model="form.planNum" controls-position="right" :min="1" :max="10"
                               style="width: 100%"><i slot="suffix" class="el-input__icon">天</i></el-input-number>
            </el-form-item>
            <el-form-item label="计划时间" prop="timeRange">
              <el-time-picker
                is-range
      ...
      <el-form ref="detailForm" :model="detailData" label-width="140px">
        ...
        <el-row>
          <el-col :span="20">
            ...
            <h4 class="form-header">巡更点详情</h4>
            <el-row>
              <el-table :data="detailData.nightPatrolPlanPointList">
                <el-table-column label="巡更点名称" align="center" key="pointName" prop="pointName"/>
                <el-table-column label="巡更点地址" align="center" key="pointSite" prop="pointSite"/>
              </el-table>
            </el-row>

            <h4 class="form-header">巡更设置</h4>
            <el-row>
              <el-col :span="6" :offset="0">
                <el-form-item label="巡更模式:">{{ planModelFormat(detailData.planModel) }}</el-form-item>
              </el-col>
              <el-col :span="6" :offset="0">
                <el-form-item label="巡更次数:">{{ detailData.planNum }}天/次</el-form-item>
              </el-col>
           <!--   <el-col :span="6" :offset="0">
        ...
        <el-row>
          <el-table :data="detailData.nightPatrolPlanOrderList">
            <el-table-column label="工单编号" align="center" key="watchmanNo" prop="watchmanNo"/>
            <el-table-column label="工单名称" align="center" key="watchmanName" prop="watchmanName"/>
            <el-table-column label="巡更类型" align="center" key="tourName" prop="tourName"/>
            <el-table-column label="巡更路线" align="center" key="routeName" prop="routeName"/>
            <el-table-column label="巡点数量" align="center" key="pointNum" prop="pointNum"/>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        gapTime: [
          {validator: validateGapTime, message: "巡更间隔频率不能为空", trigger: "blur"}
        ],
      }
    };
  },
  ...
  watch: {
    ...
    "queryParams.communityId": "selectRouteList",
  },
  methods: {
    /** 树结构 */
    init() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除所选巡更计划？').then(function () {
