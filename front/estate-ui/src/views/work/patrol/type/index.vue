<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['nightPatrol:type:add']"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['nightPatrol:type:delete']"
        >删除
        </el-button>
      </el-col>
    </el-row>
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="巡查类型" align="center" prop="tourName" show-overflow-tooltip/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" style="{'color':}">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['nightPatrol:type:edit']"
          >修改
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="巡查类型" prop="tourName">
          <el-input v-model="form.tourName" placeholder="请输入巡查类型" maxlength="32"/>
        </el-form-item>
        <el-form-item label="状态" prop="tourStatus">
...
<script>
import * as tourType from "@/api/estate/work/patrol/patrolType";
...
export default {
  data() {
    return {
      ...
      rules: {
        tourName: [
          {required: true, message: "巡查类型不能为空", trigger: "blur"}
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除所选巡查类型?(删除后此类型无法查询)').then(function () {
