        ...
        <el-col :span="20" :xs="24">
          <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="82px">
            <el-form-item label="巡更类型" prop="tourName">
              <el-select v-model="queryParams.tourName" placeholder="请选择巡更类型" clearable >
                <el-option
            ...
            <el-form-item label="巡更路线" prop="routeName">
              <el-select v-model="queryParams.routeName" placeholder="请选择巡更路线" clearable >
                <el-option
...
<!--            <el-form-item label="巡更数量" prop="pointNo">
              <el-select v-model="queryParams.pointNo" placeholder="请选择巡更数量" clearable >
                <el-option
          ...
          <el-table v-loading="loading" :data="watLedList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="巡更数量" align="center" prop="pointNo" />
      ...
      <el-form ref="form" :model="form" label-width="110px">
        ...
        <el-row>
          <el-col :span="6" :offset="1" >
            <el-form-item label="工单编号：">{{ form.watchmanNo }}</el-form-item>
          </el-col>
          <el-col :span="6" :offset="1">
            <el-form-item label="工单名称：">{{ form.watchmanName }}</el-form-item>
          </el-col>
          <el-col :span="6" :offset="1">
            <el-form-item label="巡更类型：">{{ form.tourName }}</el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="6" :offset="1">
          ...
          <el-col :span="6" :offset="1">
            <el-form-item label="巡更顺序：" >
              <div v-if="form.watchmanType == '0'">顺序</div>
              <div v-if="form.watchmanType == '1'">乱序</div>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
import {
  ...
  getWatStaList,
  listWatLed
} from "@/api/estate/work/orderLedger/watLed";
...
export default {
  ...
  methods:{
    ...
    handleDetail(row) {
      ...
      this.open = true;
      this.title = "查看详情";
      const id = row.watchmanId
      getWatLedInfo(id).then(response => {
        this.form = response.data;
      });
      getWatStaList(id).then(response => {
    ...
    getList() {
      this.openView = 0;
      this.loading = false;
      listWatLed(this.queryParams).then(response => {
        this.watLedList = response.rows;
        this.total = response.total;
        this.loading = false;
      });
      //getTourNameList
      getTourNameList(this.communityId).then(response => {
        this.tourNameList = response.data;
      });
      getRouteNameList(this.communityId).then(response => {
