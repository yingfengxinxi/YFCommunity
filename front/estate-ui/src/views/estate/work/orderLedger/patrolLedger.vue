      ...
      <el-row :gutter="20">
        ...
        <el-col :span="20" :xs="24">
          <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="82px">
            <el-form-item label="巡查类型" prop="tourName">
            ...
            <el-form-item label="分配方式" prop="allotWay">
              <el-select v-model="queryParams.allotWay" placeholder="请选择" clearable >
                <el-option
          ...
          <el-table v-loading="loading" :data="patLedList" @selection-change="handleSelectionChange">
      ...
      <el-form ref="form" :model="form" label-width="140px">
        ...
        <el-row>
          <el-col :span="6" :offset="1" >
            <el-form-item label="工单编号：">{{ form.patrolNo }}</el-form-item>
          </el-col>
          <el-col :span="6" :offset="1">
            <el-form-item label="工单名称：">{{ form.patrolName }}</el-form-item>
          </el-col>
          <el-col :span="6" :offset="1">
            <el-form-item label="巡查类型：">{{ form.tourName }}</el-form-item>
          </el-col>

        </el-row>
        <el-row>
          <el-col :span="6" :offset="1">
            <el-form-item label="巡查点：">{{ form.pointName }}</el-form-item>
          </el-col>
          <el-col :span="6" :offset="1">
        ...
        <el-row>
          <el-col :span="6" :offset="1">
            <el-form-item label="计划巡查开始时间：">{{ form.startTime }}</el-form-item>
          </el-col>
          <el-col :span="6" :offset="1">
            <el-form-item label="计划巡查结束时间：">{{form.endTime}}</el-form-item>
          </el-col>
          <el-col :span="6" :offset="1">
            <el-form-item label="结束时间：">{{form.finishTime}}</el-form-item>
          </el-col>
        ...
        <h4 class="form-header" align="left">工单执行人信息</h4>
        <el-row>
          <el-col :span="24">
            <el-table
              stripe
...
import {getPatLedInfo, getPatStaList, getTourNameList, listPatLed} from "@/api/estate/work/orderLedger/patLed";
...
export default {
  ...
  methods:{
    ...
    handleDetail(row) {
      ...
      this.open = true;
      this.title = "查看详情";
      const id = row.patrolId
      getPatLedInfo(id).then(response => {
        this.form = response.data;
      });
      getPatStaList(id).then(response => {
    ...
    getList() {
      this.openView = 0;
      this.loading = false;
      listPatLed(this.queryParams).then(response => {
