  ...
  <div class="app-container">
    ...
    <div v-show="openView === 0">
      ...
      >
        ...
        <el-form-item label="资产名称" prop="name" label-width="95px">
          <el-input
      ...
      >
        ...
        <el-table-column label="型号" align="center" prop="specifications" />
    ...
    <div v-show="openView === 1">
      <el-form ref="form1" :model="form1" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="资产类型" prop="assetType">
              <el-select v-model="form1.assetType" placeholder="请选择资产类型">
                <el-option
                  v-for="(item, index) in assetTypeOptions"
                  :key="index"
                  :label="item.name"
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="购入单价：" prop="price">
              <el-input-number
                style="width: 220px"
                v-model="form1.price"
                :min="0"
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="厂商：" prop="manufacturer">
              <el-input v-model="form1.manufacturer" placeholder="请输入厂商" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        assetType: [
          { required: true, message: "请选择资产类型", trigger: "trigger" },
        ],
        name: [
