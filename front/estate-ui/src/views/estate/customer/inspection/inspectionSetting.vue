  ...
  <div class="app-container">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="20" :xs="24">
          <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="82px">
            <el-form-item label="巡查点名称" prop="inspectName">
              <el-input
            ...
            <!-- <el-form-item label="巡查点状态" prop="inspectStatus">
              <el-select
      ...
      ></right-toolbar>
          ...
          <el-table v-loading="loading" :data="reportingWarrantyList">
            <el-table-column label="巡查点名称" align="center" key="inspectName" prop="inspectName"/>
            <el-table-column label="巡查地址" align="center" key="inspectionAddress" prop="inspectionAddress"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="60%" append-to-body>
      ...
      >
        <el-row>
          <el-col :span="10">
            <el-form-item label="巡查点名称" prop="inspectName">
            <el-input v-model="form.inspectName" placeholder="请输入巡查点名称" :style="{ width: '240px' }"/>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="10">
              <el-form-item label="巡查频率" prop="frequency" >
                <el-select :disabled="disabled"   v-model="form.frequency" placeholder="请选择巡查频率" style="width: 240px" @change="getExecutionNumberMax(form.frequency)">
                <el-option
            ...
            <el-col :span="10" :offset="1">
              <el-form-item label="执行次数" prop="executionNumber">
                <el-input-number :disabled="disabled"  @change="getFirstExecutionTime()" :min="1" :max="executionNumberMax" v-model="form.executionNumber" placeholder="请输入巡查点名称" :style="{ width: '240px' }"/>
              </el-form-item>
            </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        <el-col :span="21">
          <el-form-item label="巡查地址" prop="inspectionAddress">
            <el-input  v-model="form.inspectionAddress" placeholder="请输入清洁地址"/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
<script>
import {
  listInspectionSetting,
  getInspectionSettingDetail,
  add,
  update,
  removeById,
  updateInspectStatus,
  getTime
} from "@/api/estate/customer/inspection/inspectionSetting";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listInspectionSetting(this.queryParams).then(response => {
...
// 状态修改
  handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '"当前巡查点吗？').then(function() {
        return updateInspectStatus(row.id,row.inspectStatus);
      }).then(() => {
        this.getList();
  ...
  //巡查人员
    ...
    handleDetail(row) {
      ...
      getInspectionSettingDetail(id).then(response => {
