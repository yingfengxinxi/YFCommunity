<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="介绍" align="center" prop="listContent" :show-overflow-tooltip="true"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      ...
      <el-form-item label="介绍" prop="listContent">
          <el-input v-model="form.listContent" type="textarea" placeholder="请输入介绍" />
      </el-form-item>
...
import {
  ...
  del,
  getById
} from "@/api/estate/autonomyStatute/autonomyStatute";
import {
  getCurrentList
} from "@/api/estate/community";
export default {
  name: "AutonomyStatute",
  data() {
    return {
      isPublishOptions: [
        { value: "0", label: "否" },
      ...
      rules: {
        ...
        listContent: [{ required: true, message: "请输入介绍", trigger: "blur" }],
