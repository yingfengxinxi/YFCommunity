...
export default {
  ...
  methods: {
    ...
    getCookie() {
      const username = Cookies.get("aiotUsername");
      const password = Cookies.get("aiotPassword");
      const userType = Cookies.get("aiotUserType");
      const rememberMe = Cookies.get('aiotRememberMe')
      this.loginForm = {
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          if (this.loginForm.rememberMe) {
            Cookies.set("aiotUsername", this.loginForm.username, { expires: 30 });
            Cookies.set("aiotPassword", encrypt(this.loginForm.password), { expires: 30 });
            Cookies.set("aiotUserType", this.loginForm.userType, { expires: 30 });
            Cookies.set('aiotRememberMe', this.loginForm.rememberMe, { expires: 30 });
          } else {
            Cookies.remove("aiotUsername");
            Cookies.remove("aiotPassword");
            Cookies.remove("aiotUserType");
            Cookies.remove('aiotRememberMe');
          }
          this.$store.dispatch("AIotLogin", this.loginForm).then(() => {
