...
export default {
  ...
  created() {
    var parkSyscode = this.$route.query && this.$route.query.parkSyscode;
    this.queryParams.parkSyscode = parkSyscode;
    this.getList();
  },
  methods: {
    getList() {
    ...
    /** 重置按钮操作 */
    resetQuery() {
      var parkSyscode=this.queryParams.parkSyscode;
      this.queryParams = {
        pageNum: 1,
        pageSize: 10,
