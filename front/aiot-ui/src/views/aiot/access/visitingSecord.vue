      ...
      <el-row :gutter="20">
        <el-col>
          <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
            ...
            <el-form-item label="被访人姓名" prop="receptionistName" label-width="100px">
              <el-input
                style="width: 215px"
            ...
            <el-form-item label="被访人手机号" prop="receptionistPhoneNo" label-width="100px">
              <el-input
                style="width: 215px"
...
<script>
import { selectVisitingRecordList, selectVisitingRecordById } from "@/api/aiot/visitingSecord";
